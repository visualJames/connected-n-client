...
public class UdpCommunicator {
   ...
   * 
   * <p>
   * This will <b>not</b> return, but it will notify all registered {@link MessageListener}s on every incoming message
   * (see {@link UdpCommunicator#addMessageListener(MessageListener)}).
   * </p>
   * 
   * <p>
   * The notifications will happen on the same thread which listens for data. Therefore, don't do any lengthy
   * calculations on that thread, as you won't receive further message notifications in the mean time!
   * </p>
   */
